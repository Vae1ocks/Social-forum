...
def user_create():
    return get_user_model().objects.create_user(username='test', email='testt@test.com', password='qowieuryt')    
...
class ArticleTest(TestCase):
    ...
    def test_article_edit_without_tag(self):
        self.user = user_create()
    ...
    def article_edit_no_permission(self):
        self.user = user_create()
        self.user2 = get_user_model().objects.create_user(username='Test2', email='test@gmail.com', password='alskdjfhg')
        article = article_create(author=self.user, title='music', slug=self.slug, body=self.body, status='PB')
        url = reverse('blog:article_edit', args=(article.id, ))
        data = {
            'title': 'New Title',
    ...
    def test_comment_delete_forbidden(self):
        self.user = user_create()
        article = article_create(author=self.user, title='music', slug=self.slug, body=self.body, status='PB')
        user2 = get_user_model().objects.create_user(username='test22', password='qowieuryt', email='test@gmail.com')
